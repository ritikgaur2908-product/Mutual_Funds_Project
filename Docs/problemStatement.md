...
- Limit the corpus to the following 7 Groww scheme URLs:
...
- Official public documents to collect/reference include:
  - Scheme factsheets
...
- Fund house data (when asked about the AMC, e.g., HDFC Mutual Fund details)

**Requirements for each response:**
- Limited to a maximum of **3 sentences**.
- Includes **exactly one** citation link.
- Includes a footer: `Last updated from sources: <date>`.
